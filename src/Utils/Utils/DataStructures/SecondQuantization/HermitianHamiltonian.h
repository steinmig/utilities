...
#ifndef UTILS_SQ_HERMITIANHAMILTONIAN_H
#define UTILS_SQ_HERMITIANHAMILTONIAN_H
...
class HermitianHamiltonian : public Hamiltonian<HermitianHamiltonian> {
 public:
  // Types definition
  using Base = Hamiltonian<HermitianHamiltonian>;
  using Base::OneBodyIdentifier;
  using Base::TwoBodyIdentifier;

  /**
   * @brief Calls the Constructor of the baseclass.
   * @param moBasisSize the size of the mo basis.
   */
  explicit HermitianHamiltonian(int moBasisSize) : Base(moBasisSize){};
  /**
   * @brief Calls the Constructor of the baseclass.
   * @param moBasisSize the size of the mo basis.
   */
  explicit HermitianHamiltonian(const Specifier& specifier) : Base(specifier){};
...
#include "HermitianHamiltonian.hpp"
