...
#  ifdef __GNUC__
#    define UTILOS_EXPORT __attribute__((dllexport))
#  else
#    ifdef UtilsOS_EXPORTS
#      define UTILOS_EXPORT __declspec(dllexport)
#    else
#      define UTILOS_EXPORT __declspec(dllimport)
#    endif
#  endif
#else
#  define UTILOS_EXPORT __attribute__((visibility("default")))
#endif
