...
class NtOptimizer2 : public Optimizer {
 ...
 public:
  ...
  const std::vector<std::string> possibleExtractionOptions = {
      std::string(SettingsNames::Optimizations::Nt2::extractLastBeforeTarget),
      std::string(SettingsNames::Optimizations::Nt2::extractHighest),
      std::string(SettingsNames::Optimizations::Nt2::extractFirst),
  };
  /**
