...
Generator::Generator(Eigen::MatrixXd dataPoints, int splineDegree)
...
Generator::Generator(Eigen::MatrixXd dataPoints, int numberOfControlPoints, int splineDegree)
