...
PYBIND11_MODULE(scine_utilities, m) {
  ...
  init_thermodynamic_reference_state((m));
  init_standard_states(m);
  init_degrees_of_freedom_collection(m);
  init_molecular_degrees_of_freedom(m);
  ...
  init_rrkm_rate_constant_calculator(m);
}
